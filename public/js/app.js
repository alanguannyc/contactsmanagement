...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_v_autocomplete__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_v_autocomplete_dist_v_autocomplete_css__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_v_autocomplete_dist_v_autocomplete_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_v_autocomplete_dist_v_autocomplete_css__);
...
Vue.component('hotel-index', __webpack_require__(34));
Vue.component('contact-detail', __webpack_require__(39));
var app = new Vue({
    el: '#app'
});
...
Vue.use(__WEBPACK_IMPORTED_MODULE_0_v_autocomplete___default.a);
...
$(document).ready(function () {
    var hoteltable = $('#hotel_table').DataTable({
        ...
        columns: [{
            ...
            "defaultContent": "<i>Not set</i>" }, { data: 'created_at' }, { data: 'contacts.length' }],
        dom: 'Bfrtip',
        buttons: ['copy', 'csv', 'excel', 'pdf']
...
Component.options.__file = "resources/assets/js/components/HotelIndex.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cdc67416", Component.options)
  } else {
    hotAPI.reload("data-v-cdc67416", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getUpdate: function getUpdate() {
            ...
            var id = url.segment(-1);
            axios.get('../api/v1/hotel/' + id).then(function (res) {
                _this2.hotel = res.data[0];
                _this2.contacts = res.data[0].contacts;
            }).then().catch(function (err) {
                console.log(err);
            });
        }
              ...
              _c(
                ...
                _vm._l(_vm.contacts, function(contact) {
                  return _c("tr", { key: contact.id }, [
                    _c(
                      "td",
                      [_c("contact-detail", { attrs: { data: contact } })],
                      1
                    ),
                    _vm._v(" "),
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [
          _c("h5", [_c("strong", [_vm._v("Position")])])
        ]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [
          _c("h5", [_c("strong", [_vm._v("Title")])])
        ]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-cdc67416", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/ContactDetail.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8dd5d12c", Component.options)
  } else {
    hotAPI.reload("data-v-8dd5d12c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_autocomplete_js__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__HotelList_vue__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__HotelList_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__HotelList_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            ...
            hotelName: "",
            hotels: [],
            template: __WEBPACK_IMPORTED_MODULE_1__HotelList_vue___default.a
        };
    },
    ...
    mounted: function mounted() {
        ...
        axios.get('/api/v1/contact/' + id).then(function (resp) {
    ...
    methods: {
        ...
        updateItems: function updateItems(text) {
            this.hotels = this.hotels.filter(function (item) {
        ...
        updateContact: function updateContact() {
            ...
            if (app.hotel.name != app.hotelName) {
                axios.post('../api/v1/hotel', app.hotel).then(function (res) {

                    newContact.hotel_id = res.data.id;

                    axios.post('../api/v1/contact/edit', newContact).then(function (res) {});
                });
            } else {
        ...
        deleteContact: function deleteContact() {
            var app = this;
            var id = app.data.id;
            axios.delete('/api/v1/contact/' + id).then(function (resp) {
          ...
          [
            _c("div", { staticClass: "modal-content" }, [
              ...
              _c("div", { staticClass: "modal-body" }, [
                _c(
                  "form",
                  { attrs: { autocomplete: "off", id: "new_contact" } },
                  [
                    _c(
                      "div",
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group" }, [
                      _c("label", { attrs: { for: "contactPosition" } }, [
                        _vm._v("Position")
                      ]),
                      _vm._v(" "),
                      _c(
                        ...
                        [
                          _c("option"),
                          _vm._v(" "),
                          _c("option", [_vm._v("General Managers")]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Hotel Managers")]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Front Office Director")]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Director of HR")]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Controller")]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Director of Sales")]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Food and Beverage Director")]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Director of Marketing")]),
                          _vm._v(" "),
                          _c("option", [
                            _vm._v("Director of Public Relations")
                          ]),
                          _vm._v(" "),
                          _c("option", [
                            _vm._v("Director of Engineering/Chief Engineer")
                          ]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Director of Security")]),
                          _vm._v(" "),
                          _c("option", [
                            _vm._v("Director/Manager of Banquets")
                          ]),
                          _vm._v(" "),
                          _c("option", [
                            _vm._v("Director of Revenue/Revenue Manager")
                          ]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Purchase Manager")]),
                          _vm._v(" "),
                          _c("option", [_vm._v("Payroll Accounting")]),
                          _vm._v(" "),
                          _c("option", [
                            _vm._v("Director of IT /Digital Space")
                          ]),
                          _vm._v(" "),
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group" }, [
                      _c("label", { attrs: { for: "contactTitle" } }, [
                        _vm._v("Title")
                      ]),
                      _vm._v(" "),
                      _c("input", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8dd5d12c", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/HotelList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3ddc234b", Component.options)
  } else {
    hotAPI.reload("data-v-3ddc234b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("b", [_vm._v("#" + _vm._s(_vm.item.id))]),
    _vm._v(" "),
    _c("span", [_vm._v(_vm._s(_vm.item.name))]),
    _vm._v(" "),
    _c("abbr", [_vm._v(_vm._s(_vm.item.address))])
  ])
}
var staticRenderFns = []
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3ddc234b", module.exports)
  }
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./v-autocomplete.css", function() {
			var newContent = require("!!../../css-loader/index.js!./v-autocomplete.css");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(58)("212ebab2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8dd5d12c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ContactDetail.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8dd5d12c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ContactDetail.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
