        ...
        updateContact: function updateContact() {
            ...
            if (app.hotel.name != app.hotelName) {
                axios.post('../api/v1/hotel', app.hotel).then(function (res) {
                    ...
                    axios.post('../api/v1/contact', newContact).then(function (res) {}).then(function (res) {
                  ...
                  [
                    _c("div", { staticClass: "form-group autocomplete" }, [
                      ...
                      _c("input", {
                        ...
                        domProps: { value: _vm.hotel.name },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(_vm.hotel, "name", $event.target.value)
                          }
                        }
                      })
                    ]),
